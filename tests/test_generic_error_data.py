...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            'errors/error_with_data.pt',
            {'test_data': 'this error is given with data'},
            b'<p>this error is given with data</p>',
        ),
        (
...
def test_data_friendly_generic_sync(
    setup_global_template, status_code, template_file, template_data, expected_p_in_body
):
...
def test_data_friendly_generic_async(
    setup_global_template, status_code, template_file, template_data, expected_p_in_body
):
    @fc.template('home/index.pt')
